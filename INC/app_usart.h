...
#define usart_tx_int_enable(pUsart)     SET_TI3();//USART_ITConfig(pUsart->Usart, USART_IT_TXE, ENABLE)
#define usart_tx_int_disable(pUsart)    CLR_TI3();// USART_ITConfig(pUsart->Usart, USART_IT_TXE, DISABLE)
